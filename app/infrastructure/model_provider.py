"""Infrastructure component responsible for loading and providing the model."""
...
class ModelProvider:
    """Loads and exposes the emotion recognition model and related resources."""

    def __init__(self) -> None:
        self._resources: LoadedModelResources | None = None
    ...
    def load(self) -> LoadedModelResources:
        """
        Load model resources lazily and cache them.
        ...
        if self._resources is None:
            ...
            model = AutoModelForAudioClassification.from_pretrained(settings.model_id)
